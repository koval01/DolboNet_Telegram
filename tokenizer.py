...
import cyrtranslit
import random
from utils.emoji import random_emoj_tg 
...
class Tokenizer:
    ...
    def encode_input(self, messages, me, max_len=64):
        ...
        for message in messages:
            tokenized_input.extend(self.tokenize(messages, my_id, my_id=my_id))
    ...
    def decode_output(self, input_messages, tensor):
        tokens = []
        for idx in tensor:
