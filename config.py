...
# Как получить: https://t.me/BotFather
token = '1141221598:AAEdS1IaQ9Vnzm68f8MRLca-gFi-CHi4HIQ'

# Айди админа
ADMIN = 542956255

# С какой вероятностью бот отправит сообщение, если обнаружит сообщение с его упоминанием (от 0 до 1) (В Telegram версии не используеться)
mention_prob = 1  # 100%

# С какой вероятностью бот отправит сообщение, если обнаружит сообщение без его упоминания (от 0 до 1) (В Telegram версии не используеться)
no_mention_prob = 1  # 100%
